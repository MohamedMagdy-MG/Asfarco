...
class CarRepo implements CarInterface
{
    ...
    public function Add($data = []){ 
        ...
        $carData = [
            ...
            'airport_transfer_service_price' =>  $data['airport_transfer_service'] == true ? $data['airport_transfer_service_price'] : 0,
            'deliver_to_my_location' => $data['deliver_to_my_location'],
            'deliver_to_my_location_price' => $data['deliver_to_my_location'] == true ? $data['deliver_to_my_location_price'] : 0,
